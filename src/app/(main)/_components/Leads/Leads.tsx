              ...
              <Carousel>
                <CarouselContent className="max-w-[1100px]">
                  <CarouselItem className="md:basis-1/2">
                    {" "}
                    <div onClick={handleShowModal} className="border border-gray-400 rounded-xl p-3 min-w-[500px] max-w-[550px] pl-5">
          ...
          <div className="bg-white shadow-xl rounded-[8px] p-6 max-w-4xl mx-auto">
              <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                      ...
                      <button className="bg-purple-500 text-white px-4 py-2 rounded">Approve and send</button>
                  </div>
              </div>
              <div className="bg-blue-50 p-4 rounded mb-4">
                  <p className="text-blue-700">Jane may be interested in upgrading espresso machines for her in-store coffee shops.</p>
              </div>
              <div className="flex items-center mb-4">
                  <button className="px-4 py-2 border-b-2 border-blue-500">Engage</button>
              ...
              <div className="text-gray-500 text-sm">
                  Showing 1 of 9 <a href="#" className="text-blue-500">Show all</a>
              </div>
          </div>
      </div>
        )
